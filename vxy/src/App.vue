...
const fetchData = async () => {
  try {
    const response = await axios.post('http://localhost:3000/gitdata');
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  try {
    ...
    const response = await axios.post('http://localhost:3000/updata', requestData);
  } catch (error) {
...
// const questions = [
//   { question: "问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1问题1", answers: ["答案1", "答案1的另一个版本", '1222'] },
//   { question: "问题2", answers: ["答案2", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本", "答案2的另一个版本"] },
//   { question: "问题3", answers: ["答案3", "答案3的另一个版本"] },
//   // ... 更多问题和答案
// ];
